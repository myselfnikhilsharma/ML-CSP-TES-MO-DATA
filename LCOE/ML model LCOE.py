...
data=pd.read_excel('DATA FOR LCOE.xlsx')
...
plt.plot([8,30],[8,30],color='red',linestyle='-')
plt.xlabel('Actual LCOE', fontsize=22, fontweight='bold')
plt.ylabel('Predicted LCOE', fontsize=22, fontweight='bold')
plt.grid(True)
...
results["SVR"] = (Y_test, Y_pred_test)
...
plt.scatter(Y_test,Y_pred_test,color='blue')
plt.plot([8,30],[8,30],color='red',linestyle='-')
plt.xlabel("Actual LCOE",fontsize=20,fontweight='bold')
plt.ylabel('Predicted LCOE',fontsize=20,fontweight='bold')
plt.grid(True)
...
results["ANN"] = (Y_test, Y_pred_test)
...
file_path = "RADAR DATA LCOE.xlsx"
...
df.to_excel('COMPARISON OF ERROR LCOE.xlsx',index=0)
...
df.to_excel('residuals for LCOE.xlsx',index=0)


path = "train_test_data.xlsx"
